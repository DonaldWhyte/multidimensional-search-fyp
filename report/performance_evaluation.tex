...
\begin{figure}
	\makebox[\textwidth][c]{%
		\begin{subfloat}[\texttt{insert}\label{fig:perf3-dimensionality-insert}]{%
			\includegraphics[scale=0.5]{figures/performance_analysis/randuniform_insert.pdf}
		}
		\end{subfloat}
		\begin{subfloat}[\texttt{delete}\label{fig:perf3-dimensionality-remove}]{%
			\includegraphics[scale=0.5]{figures/performance_analysis/randuniform_delete_zoomed.pdf}
		}
		\end{subfloat}
	}%
...
\begin{figure}
	\makebox[\textwidth][c]{%
		\begin{subfloat}[\texttt{insert}\label{fig:perf3-size-insert}]{%
			\includegraphics[scale=0.5]{figures/performance_analysis/sizevary_insert_zoomed.pdf}
		}
		\end{subfloat}
		\begin{subfloat}[\texttt{delete}\label{fig:perf3-size-remove}]{%
			\includegraphics[scale=0.5]{figures/performance_analysis/sizevary_delete_zoomed.pdf}
		}
		\end{subfloat}
	}%
