...
This project will use a similar concept for evaluation. Instead of measuring the time of a single operartion, the times of measuring many thousands of operations will be measured. This is to get an idea on what the runtime of an operation is on average and prevent single, long-running operations from skewing the results. A typical performance test therefore has the following steps:
\begin{enumerate}
