...
TODO: remove the whole bit about average. State that the total will also be used, despite the size varying. Discuss 
TODO: this also means removing the performance measure column of the table below
