...
\begin{table}
	...
	\begin{tabular}{|l|l|l|l|}
		...
		\hline
	\end{tabular}
	\caption{Average Execution Time (in seconds) of Structure Operations With and Without Compiler Optimisations (10D Randomly Uniform  Dataset, 10,000 points used)}
