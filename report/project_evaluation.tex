...
This section will discuss the limitations of the project's work and future work to support or extend the project's findings. The project as a whole will be evaluated to determine if it is a success.
...
Finally, embedding, distance-based or parallel structures (all briefly mentioned in Section \ref{chap:background_research}) are avenues to explore. Based on the literature review, little research has been done on the suitability of these structure types for point queries on dynamic high-dimensional data.
