...
The implementation details of the six chosen index structures have been discussed.

TODO

The same underlying implementation is used for all three hash-based structures. Particular attention has been given to optimising this implementation to speed up can be gained on all three structures at once. 