...
This section describes the implementation details of the chosen structures, documenting the efforts that went into optimisation the structures. All execution times given in this chapter were measured by executing sequences of structure operations five times and using the average of these times. This is described in greater detail later in the report, in Section \ref{sec:timing-operations}.
