...
% TODO: remove detailed explanation and just say it requires search through entire sub-tree of deleted node to find one with a minimum value in cutting dim to maintian the invariant
