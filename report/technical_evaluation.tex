...
\begin{figure}
	\begin{center}
		\begin{subfloat}[Non-Continuous 2D Data Decomposed with Pyramid Tree\label{fig:non-continuous-embedding}]{%
			\includegraphics[scale=0.65]{figures/non_continuous_pyramid.pdf}
		}
		\end{subfloat}~~~~~~~
		\begin{subfloat}[1-Manifold Decomposed Using Pyramid Tree\label{fig:continuous-embedding-pyramid}]{%
			\includegraphics[scale=0.65]{figures/1d_manifold_pyramid.pdf}
		}
		\end{subfloat}~~~~~~~
		\begin{subfloat}[1-Manifold Decomposed using Adaptive Octree\label{fig:continuous-embedding-octree}]{%
