...
Tables containing the execution times of each structure evaluated in Chapter \ref{chap:performance-evaluation} for all datasets are provided in this section. When ``-" is shown instead of the number of seconds, it means that the performance test could not finish due to the machine running out of memory.
