...
\begin{table}
	...
	\makebox[\textwidth][c]{%
		\begin{tabular}{|l|l|l|l|l|l|}
			...
			\hline
			\textbf{Dataset} & \textbf{Time to Query (sec)} & \textbf{Average} & \textbf{St. Dev} & \textbf{Min} & \textbf{Max} \\
			\hline
			...
			\hline
			\textbf{Pyramid Tree} & & & & & \\
			500,000 16D Random Points & TODO & 1.16285 & 0.444827 & 1 & 7 \\
			500,000 Astrophysics Points & TODO & 358,645.7 & 54,145.2 & 1 & 143,496 \\
			500,000 Hurricane Isabel Points & TODO & 248,977 & 248,976 & 1 & 497,953 \\
			435,544 3D Armadillo Mesh Points & TODO & 2.45933 & 24.3335 & 1 & 1173 \\
			\hline
			\textbf{Bucket Hash Table} & & & & & \\
			500,000 16D Random Points & TODO & 1.01004 & 0.100054 & 1 & 3 \\
			500,000 Astrophysics Points & TODO & 1.01057 & 0.104108 & 1 & 4 \\
			500,000 Hurricane Isabel Points & TODO & 1.00987 & 0.0993287 & 1 & 3 \\
			435,544 3D Armadillo Mesh Points & TODO & 1.00857 & 0.0928895 & 1 & 3 \\
			\hline
		\end{tabular}
	}%
...
Table \ref{tab:perf2-bucket-stats} contains statistics on bucket size of all three hashing functions, using all real datasets TODO: discussion of results and implications
